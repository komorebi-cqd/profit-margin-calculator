    ...
    return (
        <div className='mx-auto px-2'>
            ...
            <p className="mt-2 flex items-baseline justify-center gap-x-2">
                <span className="text-2xl md:text-3xl font-bold tracking-tighter text-brand truncate">
                    {format(value,currency)}
                </span>
                <span className="text-[10px] font-semibold leading-6 tracking-wide text-gray-600 dark:text-gray-500">{currency}</span>
            </p>
            {withDivider && (
